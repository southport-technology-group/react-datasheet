  ...
  _createClass(DataSheet, [{
    ...
    value: function onMouseUp() {
      ...
      if (copydownDragging && !isEmpty(copydownTarget)) {
        ...
        var constantCoord = isVertical ? start.j : start.i;
        var changeTemplate = {};
        ...
        var startingPoint = isVertical ? offset > 0 ? start.i + 1 : start.i + offset : offset > 0 ? start.j + 1 : start.j + offset;
        var max = isVertical ? offset > 0 ? start.i + offset : start.i - 1 : offset > 0 ? start.j + offset : start.j - 1;
