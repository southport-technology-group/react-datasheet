  ...
  _createClass(DataSheet, [{
    ...
    value: function onMouseOver(i, j) {
      ...
      function calculateCopydownTarget(coords) {
        ...
        if (coords.i >= smallestI && coords.i <= largestI && coords.j >= smallestJ && coords.j <= largestJ) return {};
      ...
      if (this.state.copydownDragging) {
        ...
        var _target = calculateCopydownTarget({ i: i, j: j });
        this._setState({ copydownTarget: _target });
      }
    }
  }, {
    key: 'onMouseUp',
