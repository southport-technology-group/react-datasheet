...
var _CopyDownHandle = require('./CopyDownHandle');

var _CopyDownHandle2 = _interopRequireDefault(_CopyDownHandle);
...
var DataCell = function (_PureComponent) {
  ...
  _createClass(DataCell, [{
    ...
    key: 'isEditModeDisabled',
    value: function isEditModeDisabled() {
    ...
    value: function render() {
      var _props7 = this.props,
          ...
          copydownTargeted = _props7.copydownTargeted,
          selecting = _props7.selecting,
          copydownDragging = _props7.copydownDragging,
          lastSelected = _props7.lastSelected,
          onKeyUp = _props7.onKeyUp,
          onMouseDown = _props7.onMouseDown;
      var updated = this.state.updated;


      var editing = !this.isEditModeDisabled() && this.props.editing;
      ...
      var className = [cell.className, 'cell', cell.overflow, selected && 'selected', copydownTargeted && !cell.readOnly && 'copydown-targeted', copydownDragging && 'copydown-dragging', editing && 'editing', cell.readOnly && 'read-only', updated && 'updated'].filter(function (a) {
        return a;
      }).join(' ');
      ...
      return _react2.default.createElement(
        ...
        content,
        lastSelected && _react2.default.createElement(_CopyDownHandle2.default, { selecting: selecting, onMouseDown: onMouseDown })
      );
    }
  }]);
...
DataCell.propTypes = {
  ...
  copydownTargeted: _propTypes2.default.bool,
  selecting: _propTypes2.default.bool,
  lastSelected: _propTypes2.default.bool,
