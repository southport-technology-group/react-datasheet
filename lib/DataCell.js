...
var DataCell = function (_PureComponent) {
  ...
  _createClass(DataCell, [{
    ...
    value: function render() {
      ...
      var className = [cell.className, 'cell', cell.overflow, selected && 'selected', copydownDragging && 'copydown-dragging', editing && 'editing', cell.readOnly && 'read-only', updated && 'updated'].filter(function (a) {
        return a;
      }).join(' ');
